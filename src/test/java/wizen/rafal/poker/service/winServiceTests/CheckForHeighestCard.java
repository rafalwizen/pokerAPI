...
class CheckForHeighestCard {

	@Test
	void checkForHeighes_11_10_7_5_4_True() {
		...
		int[] output = test.checkForHeighestCard(cards);
		int[] expected = {1, 11, 10, 7, 5, 4};
	...
	@Test
	void checkForHeighes_14_10_9_8_4_True() {
		WinServiceImpl test = new WinServiceImpl();
		ArrayList<Card> cards = new ArrayList<Card>();
