...
class CheckForOnePair {

	@Test
	void checkForOnePair_pairOf4_and_12_11_8_kickers_True() {
		...
		int[] output = test.checkForOnePair(cards);
		int[] expected = {2, 4, 12, 11, 8};
	...
	@Test
	void checkForOnePair_noPair_False() {
		WinServiceImpl test = new WinServiceImpl();
		ArrayList<Card> cards = new ArrayList<Card>();
		cards.add(new Card(3, 'H'));
		cards.add(new Card(4, 'H'));
